      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-5 sm:px-8 py-5">
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          >
            ...
            <button
              className="flex items-center gap-1 text-white font-medium text-[15px] hover:text-[#A6CE39] transition-colors"
            >
      ...
      {mobileOpen && (
        ...
        <div className="lg:hidden fixed inset-0 z-[60] bg-[#0B1526] flex flex-col">
          ...
          <div className="shrink-0 px-5 pt-4 pb-6 flex flex-col gap-3 bg-[#0B1526] border-t border-white/10">
            ...
            <button
              className="flex items-center justify-center gap-2 bg-[#A6CE39] text-[#0B1526] font-semibold text-sm px-5 py-3.5 rounded-md hover:brightness-95 transition"
            >
